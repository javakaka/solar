...
$().ready(function() {
	...
	$submitButton.click(function(){
		var need_know =$("#editor").val();
		if(typeof need_know == "undefined" || need_know == "")
		{
			need_know ="";
		}
		var id =$("#id").val();
		...
		var params={id:id,need_know:need_know}
		$.ajax({
				url: "<%=basePath%>paimaipage/platform/auction/goods/saveNeedKnow.do",
				type: "POST",
				data: params,
				dataType: "json",
				cache: false,
	...
	<form id="inputForm" action="" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					<textarea id="editor" name="need_know" class="editor">${need_know}</textarea>
				</td>
			</tr>
			<tr>
				<th>
