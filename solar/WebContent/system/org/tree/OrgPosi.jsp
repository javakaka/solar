...
<table width="100%" cellpadding="2" cellspacing="1" class="table_c">
	<tr class="tr_c">
		<td class="td_c" height=40 align=center><font color=red>图示</font>：<IMG SRC="images/0pic.gif">-岗位,<IMG SRC="images/2pic.gif">-人员[人员姓名后面带<font color="red">*</font>表示此人存在多个岗位]</td>
	</tr>
	<tr class="tr_c">
		<td valign="top">
