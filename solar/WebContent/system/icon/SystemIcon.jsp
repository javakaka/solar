...
<body>
	...
	<form id="listForm" action="SystemIcon.do" method="get">
		<div class="bar">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="ICO_NAME">图标名称</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="ICO_NAME">预览</a>
				</th>
				<!--
				<th>
			...
			<c:forEach items="${page.content}" var="row" varStatus="status">
				<tr>
					<td>
						<input type="checkbox" name="ids" value="${row.ICO_NAME}" />
					</td>
					<td>
						<span title="${row.ICO_NAME}">${row.ICO_NAME}</span>
					</td>
					<td>
						<img src="<%=basePath%>images/icons/${row.ICO_NAME}" />
					</td>
					<!--
					<td>
