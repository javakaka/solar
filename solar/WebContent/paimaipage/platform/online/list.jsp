	...
	<form id="listForm" action="list.do" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="GOODS_NAME">商品名称</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="GOODS_TYPE">商品类型</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="GOODS_PRICE">送拍价格</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="CREATE_TIME">提交时间</a>
				</th>
				<th>
			...
			<c:forEach items="${page.content}" var="row" varStatus="status">
				<tr>
					...
					<td>
						<span title="${row.GOODS_TYPE}">${row.GOODS_TYPE}</span>
					</td>
					<td>
