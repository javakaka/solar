...
public abstract class StoragePlugin implements Comparable<StoragePlugin> {
	...
	@Resource(name = "frameworkPluginService")
	...
	public String getAttribute(String name) {
		String value ="";
		Row pluginConfig = getPluginConfig();
		String config_id =pluginConfig.getString("id");
		value =pluginConfigService.getPluginAttribute(config_id, name);
		return value;
	}
	...
	public Integer getOrder() {
		Row pluginConfig = getPluginConfig();
		return pluginConfig != null ? Integer.parseInt(pluginConfig.getString("orders","0") ): null;
	}
