...
$().ready(function() {
	...
	$submitButton.click(function(){
		var sale_service =$("#editor").val();
		if(typeof sale_service == "undefined" || sale_service == "")
		{
			sale_service ="";
		}
		var id =$("#id").val();
		...
		var params={id:id,sale_service:sale_service}
		$.ajax({
				url: "<%=basePath%>paimaipage/platform/auction/goods/saveSaleService.do",
				type: "POST",
				data: params,
				dataType: "json",
				cache: false,
	...
	<form id="inputForm" action="" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					<textarea id="editor" name="sale_service" class="editor">${sale_service}</textarea>
				</td>
			</tr>
			<tr>
				<th>
