...
<title><cc:message key="framework.language.add"/></title>
...
<body>
	<div class="path">
		<cc:message key="framework.nav.index" /> &raquo; <cc:message key="framework.language.add"/>
	</div>
	<form id="inputForm" action="save.do" method="post">
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" name="LAN_NO" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="LAN_NAME" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
