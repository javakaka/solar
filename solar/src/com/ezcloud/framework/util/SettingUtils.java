...
import com.ezcloud.framework.common.CommonAttributes;
import com.ezcloud.framework.common.EnumConverter;
...
public final class SettingUtils {
	...
	public static Setting get() {
		...
		if (cacheElement != null) {
			...
			setting = new Setting();
			try {
				File ezshopXmlFile = new ClassPathResource(CommonAttributes.SYSTEM_XML_PATH).getFile();
				Document document = new SAXReader().read(ezshopXmlFile);
				List<Element> elements = document.selectNodes("/ezshop/setting");
	...
	public static void set(Setting setting) {
		try {
			...
			try {
				...
				fileOutputStream = new FileOutputStream(ezshopXmlFile);
