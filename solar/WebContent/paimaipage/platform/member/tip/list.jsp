			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'ASK_CONTENT'}"> class="current"</c:if> val="ASK_CONTENT">内容</a>
						</li>
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'CREATE_TIME'}"> class="current"</c:if> val="CREATE_TIME">反馈时间</a>
						</li>
					</ul>
				</div>
			</div>
