	...
	<form id="inputForm" action="update.do" method="post">
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" name="FIELD_NAME" class="text" maxlength="200" value="${row.FIELD_NAME}" readonly />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="ITEM_TITLE" class="text" maxlength="200" value="${row.ITEM_TITLE}" />
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					...
					<option value="1" <c:if test="${row.ONLY_VIEW==1}"> selected</c:if> >是</option>
					<option value="0" <c:if test="${row.ONLY_VIEW==0}"> selected</c:if>  >否</option>
					</select>
				</td>
			</tr>
			<tr>
