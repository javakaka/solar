...
<%@page import="net.ezshop.Setting"%>
<%@page import="net.ezshop.util.SettingUtils"%>
<%@page import="net.ezshop.util.SpringUtils"%>
<%@page import="net.ezshop.Setting.CaptchaType"%>
<%@page import="net.ezshop.Setting.AccountLockType"%>
<%@page import="net.ezshop.service.RSAService"%>
...
<%
if (applicationContext != null) {
	System.out.println("context  not null 1");
...
<body>
	<%if (applicationContext != null) {  System.out.println("context not  null 2");%>
		<div class="login">
			<form id="loginForm" action="login.jsp" method="post">
				...
				<div class="powered">COPYRIGHT © 2005-2013 深圳手机店版权所有</div>
			</form>
		</div>
	<%} else {%>
		<fieldset>
			<legend>系统出现异常</legend>
			<p>请检查系统是否已正确安装 [<a href="<%=base%>/install/">马上安装</a>]</p>
			<p>
				<strong>提示: 系统安装完成后必须重新启动网站服务器</strong>
			</p>
		</fieldset>
	<%}%>
</body>
