	...
	<form id="listForm" action="list.do" method="get">
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						...
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'CREATE_TIME'}">class="current"</c:if> val="CREATE_TIME">申请时间</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="DEAL_MONEY">预期成交金额</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="SESSION_NAME">专场名称</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="START_TIME">开始时间</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="END_TIEM">结束时间</a>
				</th>
				<th>
			...
			<c:forEach items="${page.content}" var="row" varStatus="status">
				<tr>
					...
					<td>
						<span title="${row.DEAL_MONEY}">${row.DEAL_MONEY}</span>
					</td>
					<td>
					...
					<td>
						<span title="${row.END_TIEM}">${row.END_TIEM}</span>
					</td>
					<td>
						${row.CREATE_TIME}
					</td>
