...
<%
if(ServletUtil.get(request,"save") !=null)
{
	%>
	<$:A service="editFieldPremission" dynamic="false">
		<$:P name="positions" from="request"/>
		<$:P name="sites" from="request"/>
		<$:P name="roles" from="request"/>
		<$:P name="groups" from="request"/>
		<$:P name="auths" from="request"/>
		<$:P name="staffs" from="request"/>
		<$:P name="fields" from="request"/>
		<$:P name="prem_no" from="request"/>
		<$:P name="table_ename" from="request"/>
		<$:P name="op" from="request"/>
	</$:A>
	<$:M dtype="1"/>
	<script>parent.runParentRefresh();</script>
	<%
}
%>
...
<script src="<%=GlobalUtil._WEB_PATH%>/res/js/xtree2.js"></script>
<table width="100%" height="280" border="1" bordercolor="3B87D1" bordercolorlight="#FFFFFF" cellpadding="0" cellspacing="0">
   ...
   <tr>
      <$:A service="SYS_013" dynamic="false"/>
      <$:M dtype="1"/>
      <td valign=top>
...
%>
         ...
         <div id="div6" style="position:absolute; width:100%; height:95%; visibility: hidden"> 
            <DIV onscroll="setRowFixed()" style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 100%"> 
            <table id="tabMain" name="tabMain" cellpadding="3" width="100%" border=0>	
               <$:A service="SYS_003" dynamic="true">
                  <$:P name="TABLE_NAME" value="TMP_TABLE"/>
                  <$:P name="FIELD_NAME" value="AUTH_LEVEL"/>
               </$:A>
               <$:M dtype="1"/>
               <tr>
...
<%
   if(ServletUtil.getResult(request,"SYS_003") !=null)
   {
      DataSet alPremision =(DataSet)ServletUtil.getResult(request,"SYS_003");
      StringBuffer html =new StringBuffer();
            int j=0;
            if(alPremision !=null)
...
<table width=100% border="1" bordercolor="3B87D1" bordercolorlight="#FFFFFF" cellpadding="0" cellspacing="0">
  <tr bgcolor=#E8E8E8>
		...
		<td align=center>
			<table border="0" cellpadding="0" cellspacing="0" width="100%">
				...
				<tr>
                  ...
                  <$:M dtype="1"/>
                  <$:L name="source" rs="layout" valueField="FIELD_ENAME" textField="FIELD_CNAME" props="size='14' multiple style='width:100%; border:1px #E8E8E8 solid' ondblclick='ondbclk_add(document.all.source,document.all.target);'"/>
					</td>
					<td align=center>
					...
					<td>
                  <Select name='target' size='14' multiple style='multiple style='width:100%'>
						</Select>
...
<form name="grant" method="post">
   <input type=hidden name="prem_no" value="<%=ServletUtil.get(request,"prem_no")==null?"":ServletUtil.get(request,"prem_no")%>">
...
<$:A service="GetGrantPu" dynamic="true">
   <$:P name="swf_no"/>
   <$:P name="map_id"/>
</$:A>
<$:M dtype="1"/>
