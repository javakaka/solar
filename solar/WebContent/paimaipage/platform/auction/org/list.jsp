	...
	<form id="listForm" action="list.do" method="get">
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == '机构名称'}"> class="current"</c:if> val="机构名称">机构名称</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="ORG_NAME">机构名称</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="SUMMARY">机构简介</a>
				</th>
				<th>
