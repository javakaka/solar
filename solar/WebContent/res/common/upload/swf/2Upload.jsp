...
<table id="idTbAttachList" width="100%" cellpadding="2" cellspacing="1" class="table_c" align=center>
	...
	<div class="fieldset flash" id="fsUploadProgress1">
		<span class="legend">请选择文件上传：<span id="spanButtonPlaceholder1"></span><input id="btnCancel1" type="button" value="取消上传" onclick="cancelQueue(upload1);" disabled="disabled"/></span>
	</div>
</body>
</html>
