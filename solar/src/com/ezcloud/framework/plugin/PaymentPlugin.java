...
import com.ezcloud.framework.service.plugin.PluginConfigService;
...
//	private PaymentService paymentService;
	...
	public final String getId() {
		String sClassID =getClass().getAnnotation(Component.class).value();
		//System.out.println("class id ------------------------------->>:"+sClassID);
		return sClassID;
	}
	...
	public boolean getIsEnabled() {
		...
		String is_enabled =pluginConfig.getString("is_enabled","0");
	...
	public String getAttribute(String name) {
		...
		return pluginConfigService.getPluginAttribute(id, name);
	}
	...
	public Integer getOrder() {
		Row pluginConfig = getPluginConfig();
		return pluginConfig != null ? Integer.parseInt(pluginConfig.getString("orders") ): null;
	}
	...
	public String getPaymentName() {
		Row pluginConfig = getPluginConfig();
		String id=pluginConfig.getString("id");
		return pluginConfigService.getPluginAttribute(id, PAYMENT_NAME_ATTRIBUTE_NAME);
	}
	...
	public FeeType getFeeType() {
		Row pluginConfig = getPluginConfig();
		String id=pluginConfig.getString("id");
		System.out.println("pluginconfig plugin id-->"+pluginConfig.getString("id"));
		return pluginConfig != null ? FeeType.valueOf(pluginConfigService.getPluginAttribute(id,FEE_TYPE_ATTRIBUTE_NAME)) : null;
	}
	...
	public BigDecimal getFee() {
		...
		else 
		{
			...
			temp =pluginConfigService.getPluginAttribute(id,FEE_ATTRIBUTE_NAME);
			System.out.println("temp----->>>"+temp);
			big =new BigDecimal(temp);
		}
		
		return pluginConfig != null ? new BigDecimal(pluginConfigService.getPluginAttribute(id,FEE_ATTRIBUTE_NAME)) : null;
	}
	...
	public String getLogo() {
		Row pluginConfig = getPluginConfig();
		String id=pluginConfig.getString("id");
		return pluginConfig != null ? pluginConfigService.getPluginAttribute(id,LOGO_ATTRIBUTE_NAME) : null;
	}
	...
	public String getDescription() {
		Row pluginConfig = getPluginConfig();
		String id=pluginConfig.getString("id");
		return pluginConfig != null ?  pluginConfigService.getPluginAttribute(id,DESCRIPTION_ATTRIBUTE_NAME) : null;
	}
	...
	public BigDecimal calculateFee(BigDecimal amount) {
		System.out.println("calculate pay fee ...");
