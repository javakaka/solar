...
<body>
	...
	<form id="listForm" action="SiteList.do" method="get">
		<div class="bar">
			<a href="add.do?id=${id}&up_id=${up_id}" class="iconButton">
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						...
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'REAL_PHONE'}">class="current"</c:if> val="REAL_PHONE">联系方式</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="RELA_PHONE">联系方式</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="NOTES">部门简介</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="STATE">状态</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="ADDR">地址</a>
				</th>
				<th>
			...
			<c:forEach items="${page.content}" var="row" varStatus="status">
				<tr>
					...
					<td>
						<a href="edit.do?id=${row.SITE_NO}&bureau_no=${row.BUREAU_NO}"><cc:message key="admin.common.edit" /></a>
...
<script>
changeAblePageDelete("site/delete.do");
</script>
</body>
</html>