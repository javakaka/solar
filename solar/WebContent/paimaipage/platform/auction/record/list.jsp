	...
	<form id="listForm" action="list.do" method="get">
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						...
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'USERNAME'}">class="current"</c:if> val="USERNAME">用户姓名</a>
						</li>
						<li>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="FROM_USER">用户微信</a>
				</th>
				<th>
				...
				<th>
					<a href="javascript:;" class="sort" name="AUCTION_PRICE">竞拍价</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="AUCTION_TIME">竞拍时间</a>
				</th>
				<th>
			...
			<c:forEach items="${page.content}" var="row" varStatus="status">
				<tr>
					...
					<td>
						<span title="${row.FROM_USER}">${row.FROM_USER}</span>
					</td>
					<td>
					...
					<td>
						<span title="${row.AUCTION_PRICE}">${row.AUCTION_PRICE}</span>
					</td>
					<td>
						${row.AUCTION_TIME}
					</td>
					<td>
						<c:choose>
							<c:when test="${row.STATE == 1}">成交</c:when>
							<c:when test="${row.STATE == 0}">领先</c:when>
							<c:when test="${row.STATE == -1}">出局</c:when>
