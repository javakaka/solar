...
import com.ezcloud.framework.service.plugin.PluginService;
import com.ezcloud.framework.util.FreemarkerUtils;
import com.ezcloud.framework.util.SettingUtils;

/**
 * Service - 文件
 */
@Service("frameworkSystemFileService")
public class SystemFileService implements ServletContextAware {
	...
	@Resource(name = "frameworkPluginServiceImpl")
