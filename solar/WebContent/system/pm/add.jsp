...
$().ready(function() {
	...
	$inputForm.validate({
		rules: {
			MOUDLE_NAME: "required",
			MOUDLE_BEGIN_TAB: "required"
		}
	});
	...
	<form id="inputForm" action="save.do" method="post">
		<table class="input">
			<tr>
				...
				<td>
					<input type="text" name="MOUDLE_NAME" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="MOUDLE_BEGIN_TAB" class="text" maxlength="200" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="MOUDLE_DESC" class="text" maxlength="200" />
				</td>
			</tr>
