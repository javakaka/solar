...
$().ready(function() {
	...
	$submitButton.click(function(){
		var brand_info =$("#editor").val();
		if(typeof brand_info == "undefined" || brand_info == "")
		{
			brand_info ="";
		}
		var id =$("#id").val();
		...
		var params={id:id,brand_info:brand_info}
		$.ajax({
				url: "<%=basePath%>paimaipage/platform/auction/goods/saveBrandInfo.do",
				type: "POST",
				data: params,
				dataType: "json",
				cache: false,
	...
	<form id="inputForm" action="" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					<textarea id="editor" name="brand_info" class="editor">${brand_info}</textarea>
				</td>
			</tr>
			<tr>
				<th>
