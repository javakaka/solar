...
//top floder's style when mouse over top folder
function overTopItem(el) {
	with (el.style) {
		//background   = "buttonface";

		borderLeft   = "1px solid #f2f5f8";
		borderRight  = "1px solid #909398";
...
//item now selected style
function highlightSubItem(el) {
	el.style.background = "#6698DE";
	el.style.color      = "#ffffff"; //"highlighttext";
	selectedItem = el;
}

//items have been visited style
