	...
	<form id="inputForm" action="update.do" method="post">
		...
		<table class="input">
			<tr>
				...
				<td>
					<input type="hidden" name="BUREAU_NO" value="${row.BUREAU_NO}" class="text" maxlength="200" />
			...
			<tr>
				...
				<td>
					<input type="text" name="RELA_PHONE" class="text" maxlength="200"  value="${row.RELA_PHONE}"/>
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" name="ADDR" class="text" maxlength="200"  value="${row.ADDR}"/>
				</td>
			</tr>
