...
<body>
	...
	<form id="listForm" action="SystemWindow.do" method="get">
		<div class="bar">
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'WIN_TARGET'}"> class="current"</c:if> val="WIN_TARGET"><cc:message key="framework.window.win_target" /></a>
						</li>
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'WIN_DESC'}">class="current"</c:if> val="WIN_DESC"><cc:message key="framework.window.win_desc" /></a>
						</li>
					</ul>
				</div>
			</div>
		...
		<table id="listTable" class="list">
			...
			<c:forEach items="${page.content}" var="row" varStatus="status">
				<tr>
					<td>
						<input type="checkbox" name="ids" value="${row.WIN_ID}" />
					</td>
					<td>
