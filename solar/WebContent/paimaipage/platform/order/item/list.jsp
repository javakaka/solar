	...
	<form id="listForm" action="list.do" method="get">
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="GOODS_PRICE">拍品价格</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="GOODS_NUM">拍品数量</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="GOODS_MONEY">小记金额</a>
				</th>
				<!--
				<th>
					<a href="javascript:;" class="sort" name="RETURN_MONEY">退货数量</a>
				</th>
				<th>
			...
			<c:forEach items="${page.content}" var="row" varStatus="status">
				<tr>
					...
					<td>
						<span title="${row.GOODS_PRICE}">${row.GOODS_PRICE}</span>
					</td>
					<td>
						<span title="${row.GOODS_NUM}">${row.GOODS_NUM}</span>
					</td>
					<td>
						<span title="${row.GOODS_MONEY}">${row.GOODS_MONEY}</span>
					</td>
