...
<body>
	...
	<form id="listForm" action="ErrorLog.do" method="get">
		<div class="bar">
			<!--
			...
			<div class="menuWrap">
				...
				<div class="popupMenu">
					<ul id="searchPropertyOption">
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'ERROR_CODE'}"> class="current"</c:if> val="ERROR_CODE">错误代码</a>
						</li>
						<li>
							<a href="javascript:;" <c:if test="${page.searchProperty == 'OCCUR_TIME'}">class="current"</c:if> val="OCCUR_TIME">记录时间</a>
						</li>
					</ul>
				</div>
			</div>
		...
		<table id="listTable" class="list">
			<tr>
				...
				<th>
					<a href="javascript:;" class="sort" name="ERROR_CODE">错误代码</a>
				</th>
				<th width="180px">
					<a href="javascript:;" class="sort" name="OCCUR_TIME">时间</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="TERMINAL">调用终端</a>
				</th>
				<th>
					<a href="javascript:;" class="sort" name="ERROR_LOG">错误信息</a>
				</th>
				<th>
			...
			<c:forEach items="${page.content}" var="row" varStatus="status">
				<tr>
					<td>
						<input type="checkbox" name="ids" value="${row.ERROR_ID}" />
					</td>
					<td>
					...
					<td>
						<span title="${row.ERROR_LOG}">${row.ERROR_LOG}</span>
					</td>
					<td>
						<a href="edit.do?id=${row.ERROR_ID}">详情</a>
