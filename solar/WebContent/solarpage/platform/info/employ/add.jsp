	...
	<form id="inputForm" action="save.do" method="post">
		<table class="input">
			...
			<tr>
				...
				<td>
					<input type="text" name="WORKINGYEARS" class="text" maxlength="200" value="" />
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" name="ADDRESS" class="text" maxlength="200" value=""/>
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<textarea name="DESCS" class="text"  rows="3" cols="50"></textarea>
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<textarea id="editor" name="REQUIREMENT" class="editor"></textarea>
				</td>
			</tr>
			<tr>
				<th>
